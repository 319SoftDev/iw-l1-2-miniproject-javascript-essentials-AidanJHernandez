...
let newSplit = 43 + (-15.99*2)
let finalSplit =  newSplit.toFixed(2)
console.log(sibling1 + " would be able to buy 2 games, because he would be left with about $" + finalSplit + ".");
...
let newGame = game+2
let gamePrice =  newGame.toFixed(2)
let newShoes = shoes/2
let shoePrice = newShoes.toFixed(2)
console.log(`The cost of games would go up to $${gamePrice}, and the cost of shoes would go down to $${shoePrice}.`);
